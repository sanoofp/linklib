    ...
    <div className="row">
      <div className="col-md-10 mx-auto">
        ...
        <p>
          ...
          conditions in full. Do not continue to use Linklib's website if you do
        ...
        <p>
          Redistribute content from Linklib (unless content is specifically made
          for redistribution).
        </p>
        ...
        <p>
          ...
          outweighs the absence of Linklib; and (d) where the link is in the
        ...
        <p>
          No use of Linklib's logo or other artwork will be allowed for linking
