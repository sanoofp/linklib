      ...
      <div className="row">
        <div className="col-md-10 mx-auto">
          ...
          <p>
            ...
            use of Linklib's Website.
          </p>
          <br />
          <p>
            By accessing this website we assume you accept these terms and
            conditions in full. Do not continue to use Linklib's website if you
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, Linklib and/or it's licensors own the
            intellectual property rights for all material on Linklib. All
            intellectual property rights are reserved. You may view and/or print
            pages from https://linklibio.herokuapp.com for your own personal use
          ...
          <p>
            Redistribute content from Linklib (unless content is specifically
          ...
          <p>
            ...
            hyperlink outweighs the absence of Linklib; and (d) where the link
          ...
          <p>
            ...
            <a
              href="mailto:sanoofp7@gmail.com"
              title="send an email to sanoofp7@gmail.com"
            >
              sanoofp7@gmail.com
            </a>
          ...
          <p>
            No use of Linklib's logo or other artwork will be allowed for
          ...
          <h2>Credit</h2>
          <p>termsandconditionstemplate.com</p>
        </div>
      </div>
    </div>
  </React.Fragment>
