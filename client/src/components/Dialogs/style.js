...
export const SignInForm = styled.div`
  ...
  label {
    ...
    color: ${props => props.theme.font === colors.whiteAlpha ? props.theme.font : undefined} !important;
  }
  fieldset {
    border-radius: 10px;
    border-color: ${props => props.theme.font === colors.whiteAlpha ? props.theme.font : undefined } !important;
